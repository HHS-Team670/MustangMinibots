...
public class Motor extends PyCode{
 /*
 ...
 */   
   ...
   */ 
    ...
    public void __init__ (String motor, int config) {
    	p.exec("self.testMode = false;\n" + 
...
class LinkedMotors{
     ...
     */
    public void __init__(ArrayList<Motor> motors) {
        //self.motor = []
        for i in motors:
            print(i.pins)
            self.motor.append(i)
...
class Arrow{
    ...
    */
    ...
    public void __init__(int which) {
